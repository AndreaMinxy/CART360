...
//int dist = sharp.distance(); //how does this transform my data into a useable distance? //how can I turn this into a voltage so I know the distance being detected?
